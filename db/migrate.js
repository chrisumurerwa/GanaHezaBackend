...
async function migrate() {
  ...
  if (parseInt(productCount.rows[0].count, 10) === 0) {
    const products = [
      { code: '16F001.2026', name: 'Habanero',      category: 'Vegetables', quantity: 200,  unit: 'Kg', period: 'Week', price: 1500, image_url: '/uploads/products/habanero.jpg', description: 'Fresh Habanero peppers grown in the fertile highlands of Rwanda. Ideal for export and local spice markets.',       location: 'Northern Province, Rwanda' },
      { code: '16F002.2026', name: 'Avocado Hass',  category: 'Fruits',     quantity: 10,   unit: 'T',  period: 'Week', price: 1200, image_url: '/uploads/products/avocado.jpg', description: 'Premium Hass Avocados with rich, creamy texture. Grown under optimal conditions in Rwanda.',                    location: 'Western Province, Rwanda' },
      { code: '16F003.2026', name: 'French Beans',  category: 'Vegetables', quantity: 8,    unit: 'T',  period: 'Week', price: null, image_url: '/uploads/products/beans.jpg', description: 'High-quality French Beans grown for export markets.',                                                           location: 'Southern Province, Rwanda' },
      { code: '16F004.2026', name: 'Macadamia',     category: 'Nuts',       quantity: null, unit: null, period: null,   price: null, image_url: '/uploads/products/macadamia.jpg', description: 'Premium Macadamia nuts sourced from Rwandan farms.',                                                             location: 'Rwanda' },
      { code: '16F005.2026', name: 'Inyanya',       category: 'Vegetables', quantity: null, unit: null, period: null,   price: null, image_url: '/uploads/products/tomatoes.jpg', description: 'Fresh tomatoes grown locally in Rwanda.',                                                                        location: 'Rwanda' },
      { code: '16F006.2026', name: 'Maize',         category: 'Cereals',    quantity: null, unit: null, period: null,   price: null, image_url: '/uploads/products/maize.jpg', description: 'Quality maize grain sourced from Rwandan farmers.',                                                              location: 'Rwanda' },
      { code: '16F007.2026', name: 'Passion Fruit', category: 'Fruits',     quantity: 6,    unit: 'T',  period: 'Week', price: null, image_url: '/uploads/products/passion-fruit.jpg', description: 'Fresh passion fruit with vibrant aroma and flavor.',                                                            location: 'Eastern Province, Rwanda' },
      { code: '16F008.2026', name: 'Coffee',        category: 'Cash Crops', quantity: 50,   unit: 'T',  period: 'Week', price: null, image_url: '/uploads/products/coffee.jpg', description: 'Premium Rwandan coffee beans, world-renowned for their bright acidity.',                                        location: 'Rwanda' },
      { code: '16F009.2026', name: 'Avocado Hass',  category: 'Fruits',     quantity: 50,   unit: 'T',  period: 'Week', price: null, image_url: '/uploads/products/avocado.jpg', description: 'Large batch Hass Avocados available for export orders.',                                                        location: 'Rwanda' },
      { code: '16F010.2026', name: 'French Beans',  category: 'Vegetables', quantity: 5,    unit: 'T',  period: 'Week', price: null, image_url: '/uploads/products/beans.jpg', description: 'Export-grade French Beans.',                                                                                    location: 'Rwanda' },
      { code: '16F011.2026', name: 'Teja',          category: 'Chillies',   quantity: 100,  unit: 'Kg', period: 'Week', price: null, image_url: '/uploads/products/teja.jpg', description: 'Teja chilli peppers with excellent color and pungency.',                                                        location: 'Rwanda' },
      { code: '16F012.2026', name: 'Habanero',      category: 'Vegetables', quantity: 500,  unit: 'Kg', period: 'Week', price: null, image_url: '/uploads/products/habanero.jpg', description: 'Large quantity of fresh Habanero peppers available weekly.',                                                    location: 'Rwanda' },
      { code: '16F013.2026', name: 'Mangoes',       category: 'Fruits',     quantity: 30,   unit: 'T',  period: 'Week', price: null, image_url: '/uploads/products/mangoes.jpg', description: 'Sweet and juicy Rwandan mangoes in season.',                                                                    location: 'Eastern Province, Rwanda' },
      { code: '16F014.2026', name: 'French Beans',  category: 'Vegetables', quantity: 5,    unit: 'T',  period: 'Week', price: null, image_url: '/uploads/products/beans.jpg', description: 'Fresh French Beans for weekly supply.',                                                                         location: 'Rwanda' },
      { code: '16F015.2026', name: 'Avocado',       category: 'Fruits',     quantity: 20,   unit: 'T',  period: 'Week', price: null, image_url: '/uploads/products/avocado.jpg', description: 'Fresh Avocados sourced from Rwandan farmers.',                                                                   location: 'Rwanda' },
    ];
